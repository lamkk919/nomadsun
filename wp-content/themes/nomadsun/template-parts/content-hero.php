...
<!-- here we used an inline style attribute to attach our hero image as a css background directly onto the element -->

<!-- here we make the hero have a min-height of 100vh, cover the background, center it, add flexbox and make the content cetner vertically and horizontally -->
...
<?php endif; ?>">
    ...
    <?php if( get_field('date') ): ?>
        ...
        <p class="f6 date archivo ma0 white ttu tracked">
            <?php
                // here we convert our date into format that php can work with, and then we format it to be nice and readable
